...
```{code-cell} ipython3
# votre code
photo = plt.imread(fname = 'data/les-mines.jpg')
plt.imshow(photo) ;
```
...
```{code-cell} ipython3
# votre code
photo.flags.writeable
copiephoto = np.copy(photo)
```
...
```{code-cell} ipython3
# votre code
print('dimension de l image :', np.ndim(copiephoto))
print( 'taille de l image :' , np.shape(copiephoto))
```
...
```{code-cell} ipython3
# votre code
print(copiephoto.itemsize,copiephoto.dtype)
```
...
```{code-cell} ipython3
# votre code
print(copiephoto.max(), copiephoto.min())
```
...
```{code-cell} ipython3
# votre code
plt.imshow(copiephoto[0:10,0:10,:])
```
...
copiephoto.shape
(l,c) = (100,200)
milieu_ligne = copiephoto.shape[0]//2
milieu_colonne = copiephoto.shape[1]//2
plt.imshow(copiephoto[milieu_ligne - l//2 : milieu_ligne + l//2 , milieu_colonne - c//2 : milieu_colonne +c//2, :])
```
...
```{code-cell} ipython3
# votre code
plt.imshow(copiephoto[:,:,0])
plt.show()
plt.imshow(copiephoto[:,:,1])
plt.show()
plt.imshow(copiephoto[:,:,2])
plt.show()
```
...
```{code-cell} ipython3
# votre code
plt.imshow(copiephoto[:,:,0], cmap = 'Reds')
plt.show()
plt.imshow(copiephoto[:,:,1], cmap = 'Greens')
plt.show()
plt.imshow(copiephoto[:,:,2], cmap = 'Blues')
plt.show()
```
